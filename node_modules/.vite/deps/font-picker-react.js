      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          return [2, fontsOriginal.map(function(fontOriginal) {
            ...
            return __assign(__assign({}, others), { family, id: getFontId(family), scripts: subsets });
          })];
      }
    });
  });
...
function stylesheetExists(fontId, isPreview) {
  ...
  if (isPreview === null || isPreview === void 0) {
...
var FontManager = function() {
  function FontManager2(apiKey, defaultFamily, _a, onChange) {
  ...
  FontManager2.prototype.init = function() {
    return __awaiter(this, void 0, void 0, function() {
  ...
  FontManager2.prototype.getFonts = function() {
    return this.fonts;
  };
  FontManager2.prototype.addFont = function(fontFamily, downloadPreview) {
  ...
  FontManager2.prototype.removeFont = function(fontFamily) {
    this.fonts["delete"](fontFamily);
  };
  FontManager2.prototype.getActiveFont = function() {
  ...
  FontManager2.prototype.setActiveFont = function(fontFamily, runOnChange) {
    var _this = this;
  ...
  FontManager2.prototype.setOnChange = function(onChange) {
    this.onChange = onChange;
  };
  return FontManager2;
}();

// node_modules/font-picker-react/dist/FontPicker.es.js
...
function getFontId2(fontFamily) {
  return fontFamily.replace(/\s+/g, "-").toLowerCase();
}
var FontPicker = function(_super) {
  __extends(FontPicker2, _super);
  function FontPicker2(props) {
    ...
    _this.componentDidUpdate = function(prevProps) {
      var _a2 = _this.props, activeFontFamily2 = _a2.activeFontFamily, onChange2 = _a2.onChange;
      if (activeFontFamily2 !== prevProps.activeFontFamily) {
        _this.setActiveFontFamily(activeFontFamily2);
      }
      if (onChange2 !== prevProps.onChange) {
        _this.fontManager.setOnChange(onChange2);
      }
    };
    ...
    _this.onSelection = function(e) {
      var target = e.target;
      var activeFontFamily2 = target.textContent;
      if (!activeFontFamily2) {
        throw Error("Missing font family in clicked font button");
      }
      _this.setActiveFontFamily(activeFontFamily2);
      _this.toggleExpanded();
    };
    _this.setActiveFontFamily = function(activeFontFamily2) {
      _this.fontManager.setActiveFont(activeFontFamily2);
    };
    _this.generateFontList = function(fonts) {
      var activeFontFamily2 = _this.props.activeFontFamily;
      var loadingStatus = _this.state.loadingStatus;
      if (loadingStatus !== "finished") {
        return import_react.default.createElement("div", null);
      }
      return import_react.default.createElement("ul", { className: "font-list" }, fonts.map(function(font) {
        var isActive = font.family === activeFontFamily2;
        var fontId = getFontId2(font.family);
        return import_react.default.createElement(
          "li",
          { key: fontId, className: "font-list-item" },
          import_react.default.createElement("button", { type: "button", id: "font-button-" + fontId + _this.fontManager.selectorSuffix, className: "font-button " + (isActive ? "active-font" : ""), onClick: _this.onSelection, onKeyPress: _this.onSelection }, font.family)
        );
      }));
    };
    ...
    _this.render = function() {
      var _a2 = _this.props, activeFontFamily2 = _a2.activeFontFamily, sort2 = _a2.sort;
      ...
      return import_react.default.createElement(
        "div",
        { id: "font-picker" + _this.fontManager.selectorSuffix, className: expanded ? "expanded" : "" },
        import_react.default.createElement(
          "button",
          { type: "button", className: "dropdown-button", onClick: _this.toggleExpanded, onKeyPress: _this.toggleExpanded },
          import_react.default.createElement("p", { className: "dropdown-font-family" }, activeFontFamily2),
          import_react.default.createElement("p", { className: "dropdown-icon " + loadingStatus })
        ),
...
var FontPicker_es_default = FontPicker;
export {
  FontPicker_es_default as default
};
/*! Bundled license information:

@samuelmeuli/font-manager/dist/index.es.js:
  (*! *****************************************************************************
...
font-picker-react/dist/FontPicker.es.js:
  (*! *****************************************************************************
  Copyright (c) Microsoft Corporation. All rights reserved.
  Licensed under the Apache License, Version 2.0 (the "License"); you may not use
  this file except in compliance with the License. You may obtain a copy of the
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=font-picker-react.js.map
